"""
User Defined Selenium Browser to reactivate credentials
"""
...
class Activator(webdriver.Chrome):
    """Main Activator to be used in validation.
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(Activator, self).__init__(self.chromedriver_path, options=self.get_options(),
